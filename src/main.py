...
from src.data.make_test_data import create_test_data
...
"""
train_df = build_features(df, use_vanilla_data=True)
...
"""
test_df = create_test_data(r"./../../data/raw/test_values.csv", use_vanilla_data=True)
