...
def visualise_train_data(df):
    ...
    ov_stone = df.pivot_table(index='damage_grade', columns='has_superstructure_stone_flag', values='building_id',
                              aggfunc=len, fill_value=0)
    ov_cement = df.pivot_table(index='damage_grade', columns='has_superstructure_cement_mortar_stone', values='building_id',
                               aggfunc=len, fill_value=0)
    ov_mmb = df.pivot_table(index='damage_grade', columns='has_superstructure_mud_mortar_brick', values='building_id',
                            aggfunc=len, fill_value=0)
    ov_cmb = df.pivot_table(index='damage_grade', columns='has_superstructure_cement_mortar_brick', values='building_id',
                            aggfunc=len, fill_value=0)
    ov_tim = df.pivot_table(index='damage_grade', columns='has_superstructure_timber', values='building_id', aggfunc=len,
                            fill_value=0)
    #
    ov_bam = df.pivot_table(index='damage_grade', columns='has_superstructure_bamboo', values='building_id', aggfunc=len,
                            fill_value=0)
    ...
    ov_eng = df.pivot_table(index='damage_grade', columns='has_superstructure_rc_engineered', values='building_id',
                            aggfunc=len, fill_value=0)
    ov_other = df.pivot_table(index='damage_grade', columns='has_superstructure_other', values='building_id', aggfunc=len,
                              fill_value=0)
    ...
    ov_agri = df.pivot_table(index='damage_grade', columns='has_secondary_use_agriculture', values='building_id',
                             aggfunc=len, fill_value=0)
    ov_hotel = df.pivot_table(index='damage_grade', columns='has_secondary_use_hotel', values='building_id', aggfunc=len,
                              fill_value=0)

    ov_rent = df.pivot_table(index='damage_grade', columns='has_secondary_use_rental', values='building_id', aggfunc=len,
                             fill_value=0)
    ov_inst = df.pivot_table(index='damage_grade', columns='has_secondary_use_institution', values='building_id',
                             aggfunc=len, fill_value=0)
    ov_school = df.pivot_table(index='damage_grade', columns='has_secondary_use_school', values='building_id', aggfunc=len,
                               fill_value=0)
    ...
    ov_health = df.pivot_table(index='damage_grade', columns='has_secondary_use_health_post', values='building_id',
                               aggfunc=len, fill_value=0)
    ov_gov = df.pivot_table(index='damage_grade', columns='has_secondary_use_gov_office', values='building_id', aggfunc=len,
                            fill_value=0)
    ov_pol = df.pivot_table(index='damage_grade', columns='has_secondary_use_use_police', values='building_id', aggfunc=len,
                            fill_value=0)
    ov_su_other = df.pivot_table(index='damage_grade', columns='has_secondary_use_other', values='building_id', aggfunc=len,
                                 fill_value=0)
